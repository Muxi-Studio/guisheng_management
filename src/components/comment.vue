<template>
  <div class="wrap">
    <el-table :data="tableData" border style="width: 100%">
      <el-table-column prop="user_role" label="状态" width="100" :filters="[{ text: '作者', value: 1 }, { text: '用户', value: 0 }]" :filter-method="filterTag" inline-template>
      ...
      <el-table-column prop="likes" label="评论点赞" width="100">
      </el-table-column>
      <el-table-column width="100" :context="_self" inline-template label="操作">
    ...
    <div class="block">
      <el-pagination @current-change="handleCurrentChange" :current-page="currentPage1" layout="total, prev, pager, next" :total="count">
      </el-pagination>
    </div>
  </div>
</template>
